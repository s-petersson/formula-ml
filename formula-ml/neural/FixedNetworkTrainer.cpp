...
FixedNetworkTrainer::FixedNetworkTrainer() {
    track = new TrackModel(glm::vec3(35.169220, -702.223755, 5.000004), "./res/models/circuit_narrow.model", false);
...
void FixedNetworkTrainer::run() {
    TrackModel* track = new TrackModel(glm::vec3(35.169220, -702.223755, 5.000004), "./res/models/circuit_narrow.model", false);
