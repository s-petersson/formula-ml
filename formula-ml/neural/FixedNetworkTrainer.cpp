...
FixedNetworkTrainer::FixedNetworkTrainer() {
    track = new TrackModel(glm::vec3(35.169220, -702.223755, 5.000004), "./res/models/circuit_narrow.model", true);
...
void FixedNetworkTrainer::run() {
    TrackModel* track = new TrackModel(glm::vec3(35.169220, -702.223755, 5.000004), "./res/models/circuit_narrow.model", true);
...
SimulationResult FixedNetworkTrainer::runSimulation(neural::Network* network, TrackModel* track) {
	...
	sim->track = track;
	CarModel carModel = CarModel(sim->track->get_start_grid_pos(), glm::vec3(-0.616278410f, -0.787541449f, 0), 0.f, 0.f, 15.f);
	sim->car = &carModel;
