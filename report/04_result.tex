...
\begin{table}[h!] 
  ...
  \begin{tabular}{rrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Showing the time to complete a lap with the constant speed of 12.0 m/s after given generation.}
...
%Check for longer training sessions
It seemed like it did not learn to distinguish properly between the different difficulties, and simple did the same behaviour in miniature. Worth noting was that these training sessions lasted for only about $2$ generations to $600$ generations. We have not proven that it is not possible if one trains for longer.
