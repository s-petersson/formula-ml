...
%X - How does the behaviour progress? What tendencies can be seen during the training? What kind of problems does it get stuck at?
% - Training, Data
...
distance from the line to the edge of the track changes, and the car keeps that distance the edge until it goes through the next corner.
...
% TODO: Move down to comparison between fixed and full control
...
% Vi kan få viss generellt beteende generell kunskap. 
