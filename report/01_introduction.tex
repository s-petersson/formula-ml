...
% Simulationshastighet
% Återställa bilen och evaluera flera AIs samtidigt
...
% The AI will operate within a virtual environment in order to increase the flexibility of the car and its environment, compared to operating a car in the real world. Due to the simulator being able to evaluate behaviour  
