...
%Adaptive Representations for Reinforcement Learning contains a sections regarding the differences between NEAT and FS-NEAT. The authors highlight these differences by applying both methods on a simulated car that is driving around a track. 
